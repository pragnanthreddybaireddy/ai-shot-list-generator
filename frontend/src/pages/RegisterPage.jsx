  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-8 glass-card rounded-2xl relative overflow-hidden group">
      ...
      <div className="relative">
        <h2 className="font-display text-3xl tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 mb-2">REGISTER</h2>
        <p className="text-sm text-studio-muted mb-8">Create your private studio workspace</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Password (Min 6 chars)</label>
            <input
              type="password"
              value={password}
        ...
        <p className="mt-6 text-center text-sm text-studio-muted">
          Already have an account? <Link to="/login" className="text-studio-neon hover:text-white transition-colors">Login</Link>
        </p>
      </div>
    </div>
  );
